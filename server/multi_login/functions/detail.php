<?php
      ...
      if (!isset($_GET["id"])) {
            ...
            global $data;
            $id = $_GET["id"];
            $query = "  SELECT us.id, us.user_type, ui.first_name, ui.last_name, ui.district, ui.city, t.avatar_image, s.subject, s.class, s.salary, s.num_of_std, s.exp, s.eval, s.star, t.experience, t.info, t.profile_image
